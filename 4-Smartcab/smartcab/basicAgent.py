...
class LearningAgent(Agent):
    ...
    def choose_action(self, state):
        ...
        if not self.testing and not self.learning or random.random() < self.epsilon:
            return random.choice([None, 'left', 'right', 'forward'])
        else:
...
def run():
    ...
    sim = Simulator(env, update_delay=0, display=False, log_metrics=True)
